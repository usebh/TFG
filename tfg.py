...
"""
Crea otra función llamada ejercicio1. Esta función recibe un único argumento que es un dataframe.
...
df = AV.AutoViz('WSCSV.csv')
df = AV.AutoViz('WSCSV.csv', depVar='Protocol')
df = AV.AutoViz('WSCSV.csv', depVar='Destination')


dataframe.to_csv("WSCSV.csv", index=False)
